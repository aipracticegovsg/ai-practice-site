...
1.  **⚡ Agility:** Quick thinking and on-the-spot reasoning. Can the candidate pivot when the data changes?
2.  **⏳ Pace:** The ability to solve problems within realistic timeframes (simulated via time-boxed case studies).
3.  **🧱 Baseline:** Non-negotiable scripting (Python/SQL) and core ML model building skills.
